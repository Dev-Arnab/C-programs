...
int main(int argc, char** argv)
{
	...
	while (input[0] != 'q')
	{
		...
		*/
		...
		Getting 10 / 100. 9 cases are failing and I have no idea why!I have even covered the cases where input has 0 at star, end.
			Atharv Manish KarbhariAssignment : When Will They Stop · 5 months ago
			/*
